...
internal sealed class AccessListView : Window, IAutoSaveContent
{
    ...
    private void ValidateGroupId()
    {
        ...
        groupId.ColorScheme = groupIdInvalid ? TerminalTheme.Error : TerminalTheme.Window;
    ...
    private ListView MakeColumn(string title, int x, List<string> data, out View frame)
    {
        ...
        var lv = new ListView(data) { X = 0, Y = 0, Width = Dim.Fill(), Height = Dim.Fill(1), ColorScheme = TerminalTheme.Window };
