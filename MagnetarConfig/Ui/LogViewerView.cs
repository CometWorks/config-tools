...
internal sealed class LogViewerView : Window
{
    ...
    public LogViewerView(InstanceBinding binding) : base("Logs")
    {
        ...
        {
            X = 1, Y = 1, Width = 20, Height = Dim.Fill(2), ColorScheme = TerminalTheme.Window,
        };
        ...
        text = new LogTextView
        {
            ...
            ReadOnly = true, WordWrap = wrapEnabled, ColorScheme = TerminalTheme.Window,
        };
        ...
        { X = 1, Y = Pos.AnchorEnd(1), Width = Dim.Fill(1), ColorScheme = TerminalTheme.Window };
    ...
    private void PromptSearch()
    {
        ...
        var dlg = new Dialog("Find", 60, 11) { ColorScheme = TerminalTheme.Dialog };
